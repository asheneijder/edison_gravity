...
namespace App\Filament\App\Resources\SwiftMessages\Tables;
            ...
            ->columns([
                ...
                TextColumn::make('location')
                    ...
                    ->state(function (\App\Models\SwiftMessage $record) {
                        ...
                        if (!$filename) {
                            // Smart Fallback used in Unit Test
            ...
            ->recordActions([
                ...
                \Filament\Actions\Action::make('download')
                    ...
                    ->action(function (\App\Models\SwiftMessage $record) {
                        ...
                        $filename = $filename ?? $record->source_file;
                        // ashraf29122025 : usage of Storage::path() to allowing download via response() for local/docker flexibility
                        return response()->download(\Illuminate\Support\Facades\Storage::disk('swift')->path('outbound/' . $record->type . '/' . $filename));
                    }),
            ])
            ->toolbarActions([
